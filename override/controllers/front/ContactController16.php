    ...
    public function postProcess()
    {
        if (Tools::isSubmit('submitMessage')) {
            ...
            if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
                ...
                // check spam with cleantalk /////////////////////////
                $spamCheckResult = Validate::spamCheckMessage('', $from, $message);
                if ($spamCheckResult->allow == 0){
                    return $this->error = $this->l('Message forbidden. Reason: '.$spamCheckResult->comment);
                }
                //////////////////////////////////////////////////////
